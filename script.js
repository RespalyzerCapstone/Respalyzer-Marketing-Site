$(document).ready(function() {
    ...
    $('#fullpage').fullpage({
      scrollBar: true,
      navigation: true,
      navigationTooltips: ['This is:', 'We aim to:', 'Please note', 'Lets Try it', 'Recording', 'Positive Results', 'Negative Results', 'Coming to', 'Meet the Team', 'Janai', 'PJ', 'Peter', 'Ryan'],
      loopBottom: true,
  ...
  int = -1;
  color_array = ['#e8eddf' ,'#73ad46', '#FFFFFF' ,'#73ad46', '#437b18', '#ffffff', '#e8eddf','#2e83e4' , '#73ad46', '#0770a0' ,'#05518b', '#d93434', '#73ad46'];
